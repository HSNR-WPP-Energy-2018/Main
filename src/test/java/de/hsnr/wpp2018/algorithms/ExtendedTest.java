...
/**
 * Extended test for evaluating the algorithm performance for different missing ranges
 */
public class ExtendedTest {
    ...
    /**
     * Test all algorithms with different missing elements and write the result into a file
     * Each missing option (week, day, hour, element) is tested for values between 0 and 0.5 missing data with an interval of 0.1. All combinations are tested
     *
     * @throws IOException io error
     */
    @Test
    ...
    /**
     * Test all algorithms for different percentages of missing single elements
     *
     * @throws IOException io error
     */
    @Test
    ...
    /**
     * Test all heuristics based on an dataset generated by the averaging interpolation.
     * The same configurations of missing elements like in {@link ExtendedTest#testRanges()} is used.
     *
    ...
    /**
     * Data model for the test results of a given configuration.
     * The differences property contains the distance for the algorithm / heuristic identified by the key.
     */
